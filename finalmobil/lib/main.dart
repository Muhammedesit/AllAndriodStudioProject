...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
            ...
            children: <Widget>[
              Container(
                decoration: const BoxDecoration(
                  color: Color(0xE19D20A8),
                ),
                alignment: Alignment.centerLeft,
                padding: const EdgeInsets.all(16.5),
                child: const Text(
                  'Hello friend',
                  style: TextStyle(fontSize: 20, color: Color(0xE1EFE3E3),),
                ),
              ),
              ListTile(
                leading: const Icon(Icons.edit),
                title: const Text("Add_New_Game"),
                onTap: () {
      ...
      appBar: AppBar(
        title: const Text("Free to Play Game"),
        actions: [
          PopupMenuButton(
        ...
        children: [
          ...
          Padding(
            ...
            child: Text(
              game.genre,
              textAlign: TextAlign.center,
              style: const TextStyle(fontSize: 23,color: Color(0xE15F5757),),
            ),
          ),
          Padding(
